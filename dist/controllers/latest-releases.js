...
`;
const latestReleases = async (req, res) => {
    try {
        const { genre = "", genres_excs = [], genres_incs = [], init = 18, multi = false, page = 1, size = 36 } = req.query;
...
exports.latestReleases = latestReleases;
